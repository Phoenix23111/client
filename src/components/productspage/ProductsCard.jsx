...
const ProductsCard = ({ data, addToCartModal }) => {
  ...
  return (
    <div className="shadow-lg lg:hover:shadow-lg  lg:hover:shadow-black/40 lg:hover:cursor-pointer lg:hover:scale-110 transition-all overflow-hidden duration-500 rounded-xl flex flex-col   items-center w-64 h-[22rem] md:w-72 md:h-96  m-4  backdrop-blur-sm bg-secondary/40 p-3 ">
      {/* image */}
