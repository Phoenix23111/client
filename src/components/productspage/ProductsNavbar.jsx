...
import { BsCart2, BsChevronLeft } from "react-icons/bs";
        ...
        <div className="w-full relative flex items-center justify-center gap-10 px-2 md:px-20 md:justify-between h-16">
          ...
          {match ? (
            <>
              {/* go back button */}
              <button
                className="flex  items-center flex-wrap  rounded-lg text-sm md:text-xl w-28 h-10 "
                onClick={() => {
                  navigate(-1);
                }}
              >
                <BiChevronLeft className="font-extrabold text-2xl md:text-4xl " />{" "}
                Go Back
              </button>
              {/* Logo */}
              <Link
            ...
            <>
              ...
              >
                <BiChevronLeft className="font-extrabold text-lg md:text-xl " />
                Continue Shopping
              </button>
              {/* Logo */}
              <Link
            ...
            // Navbar for simple Products display
            <>
              {/* Menu button */}
              <div
